<template>
  <div>
    <div v-if="current">
      <li
        class="p-4 mb-3 list-group-item shadow-sm bg-secondary rounded-lg cursor-move border-0"
      >
...
<!--        </i>-->
        <b-row>
          ...
          <b-col cols="10">
            ...
            <p class="text-gray-700 font-weight-bolder font-sans">{{ s.title }}</p>
          </b-col>
        </b-row>
      </li>
    </div>
